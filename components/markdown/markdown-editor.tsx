  ...
  const extensions = useMemo(
    () => [
      ...
      Paragraph.extend({
        ...
        addAttributes() {
          return {
            ...
            class: {
              default:
                "text-foreground leading-relaxed my-4 first:mt-0 last:mb-0",
            },
          };
        },
      }),
      ...
      Blockquote.extend({
        ...
        HTMLAttributes: {
          class:
            "my-5 pl-4 py-1 border-l-2 border-border text-muted-foreground",
        },
      }),
      CodeBlock.extend({
        draggable: true,
      ...
      Image.configure({
        ...
        HTMLAttributes: {
          class:
            "max-w-full h-auto rounded-xl border border-border/40 shadow-sm my-5",
        },
      }),
      TableKit.configure({
        table: {
          ...
          HTMLAttributes: {
            class:
              "w-full text-sm my-5 rounded-xl border border-border/60 overflow-hidden",
          },
        },
        tableHeader: {
          HTMLAttributes: {
    ...
    >
      ...
      <div className="flex-1 overflow-auto">
        <div className="mx-auto px-6 pb-12 max-w-4xl">
          ...
          />
          <div className="tiptap-editor pt-6 relative">
