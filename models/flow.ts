...
export function newFlow(index: number, type: "primary" | "secondary", switchSpeakers = false): Flow | null {
  const currentDebateStyle = debateStyles[debateStyleMap[settings.data.debateStyle.value as number]]
  // get new id
  let id = 0
